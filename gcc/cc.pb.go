...
type PipelineConfig struct {
	...
	PipelineGpath      string                 `protobuf:"bytes,2,opt,name=pipeline_gpath,json=pipelineGpath,proto3" json:"pipeline_gpath,omitempty"`                   // GPath (业务唯一路径) [required]
...
func (x *PipelineConfig) GetPipelineGpath() string {
	if x != nil {
		return x.PipelineGpath
	}
	return ""
}
...
type CreatePipelineDraftRequest struct {
	...
	PipelineGpath      string                 `protobuf:"bytes,5,opt,name=pipeline_gpath,json=pipelineGpath,proto3" json:"pipeline_gpath,omitempty"`                  // 外部指定的 pipeline_gpath (业务唯一路径) [required for fresh creation]
...
func (x *CreatePipelineDraftRequest) GetPipelineGpath() string {
	if x != nil {
		return x.PipelineGpath
	}
	return ""
...
type GetPipelineRequest struct {
	...
	//	*GetPipelineRequest_PipelineGpath
...
func (x *GetPipelineRequest) GetPipelineGpath() string {
	if x != nil {
		if x, ok := x.Query.(*GetPipelineRequest_PipelineGpath); ok {
			return x.PipelineGpath
		}
	}
	return ""
...
type GetPipelineRequest_PipelineGpath struct {
	PipelineGpath string `protobuf:"bytes,2,opt,name=pipeline_gpath,json=pipelineGpath,proto3,oneof"`
}

func (*GetPipelineRequest_PipelineId) isGetPipelineRequest_Query() {}

func (*GetPipelineRequest_PipelineGpath) isGetPipelineRequest_Query() {}
...
type PipelineSummary struct {
	...
	PipelineGpath      string                 `protobuf:"bytes,2,opt,name=pipeline_gpath,json=pipelineGpath,proto3" json:"pipeline_gpath,omitempty"`
...
func (x *PipelineSummary) GetPipelineGpath() string {
	if x != nil {
		return x.PipelineGpath
	}
	return ""
...
type GetPipelineDetailRequest struct {
	...
	//	*GetPipelineDetailRequest_PipelineGpath
...
func (x *GetPipelineDetailRequest) GetPipelineGpath() string {
	if x != nil {
		if x, ok := x.Query.(*GetPipelineDetailRequest_PipelineGpath); ok {
			return x.PipelineGpath
		}
	}
	return ""
...
type GetPipelineDetailRequest_PipelineGpath struct {
	PipelineGpath string `protobuf:"bytes,2,opt,name=pipeline_gpath,json=pipelineGpath,proto3,oneof"`
}

func (*GetPipelineDetailRequest_PipelineId) isGetPipelineDetailRequest_Query() {}

func (*GetPipelineDetailRequest_PipelineGpath) isGetPipelineDetailRequest_Query() {}
...
const file_cc_proto_rawDesc = "" +
	"\n" +
	"\bcc.proto\x12\x03gcc\x1a\x1bgoogle/protobuf/empty.proto\"\xfd\x04\n" +
	"\x0ePipelineConfig\x12\x1f\n" +
	"\vpipeline_id\x18\x01 \x01(\tR\n" +
	"pipelineId\x12%\n" +
	"\x0epipeline_gpath\x18\x02 \x01(\tR\rpipelineGpath\x12\x18\n" +
	...
	"\x05certs\x18\x12 \x03(\v2\x12.gcc.QualificationR\x05certs\x12\x18\n" +
	...
	"\vdescription\x18\x17 \x01(\tR\vdescriptionJ\x04\b\r\x10\x0eJ\x04\b\x0e\x10\x0fJ\x04\b\x0f\x10\x10J\x04\b\x10\x10\x11J\x04\b\x13\x10\x14\"\x82\x01\n" +
	"\vStageConfig\x12\x19\n" +
	"\bstage_id\x18\x01 \x01(\tR\astageId\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12\x1d\n" +
	"\n" +
	"sort_order\x18\x03 \x01(\x05R\tsortOrder\x12%\n" +
	"\x05units\x18\x04 \x03(\v2\x0f.gcc.UnitConfigR\x05units\"\xab\x02\n" +
	"\n" +
	"UnitConfig\x12\x17\n" +
	...
	"J\x04\b\x0e\x10\x0fJ\x04\b\x0f\x10\x10J\x04\b\x10\x10\x11J\x04\b\x11\x10\x12J\x04\b\x12\x10\x13J\x04\b\x13\x10\x14\"y\n" +
	"\rQualification\x12\x17\n" +
	"\aqual_id\x18\x01 \x01(\tR\x06qualId\x12\x1b\n" +
	"\tname_hint\x18\x02 \x01(\tR\bnameHint\x12&\n" +
	"\x0fpdf_template_id\x18\x03 \x01(\tR\rpdfTemplateIdJ\x04\b\x04\x10\x05J\x04\b\x05\x10\x06\"\xc1\x02\n" +
	"\x1aCreatePipelineDraftRequest\x12#\n" +
	"\rcategory_tips\x18\x01 \x01(\tR\fcategoryTips\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12\x1f\n" +
	"\vpipeline_id\x18\x04 \x01(\tR\n" +
	"pipelineId\x12%\n" +
	"\x0epipeline_gpath\x18\x05 \x01(\tR\rpipelineGpath\x12\x18\n" +
	...
	"certsQuals\x12(\n" +
	"\x05certs\x18\v \x03(\v2\x12.gcc.QualificationR\x05certsJ\x04\b\a\x10\bJ\x04\b\b\x10\tJ\x04\b\t\x10\n" +
	"J\x04\b\n" +
	"\x10\vJ\x04\b\f\x10\r\"9\n" +
	...
	"\bnew_name\x18\x02 \x01(\tH\x00R\anewName\x88\x01\x01\x125\n" +
	"\x14thumbnail_object_key\x18\a \x01(\tH\x01R\x12thumbnailObjectKey\x88\x01\x01\x123\n" +
	"\x13thumbnail_file_hash\x18\b \x01(\tH\x02R\x11thumbnailFileHash\x88\x01\x01\x12%\n" +
	"\vdescription\x18\t \x01(\tH\x03R\vdescription\x88\x01\x01B\v\n" +
	"\t_new_nameB\x17\n" +
	"\x15_thumbnail_object_keyB\x16\n" +
	"\x14_thumbnail_file_hashB\x0e\n" +
	"\f_descriptionJ\x04\b\x03\x10\x04J\x04\b\x04\x10\x05J\x04\b\x05\x10\x06J\x04\b\x06\x10\a\"i\n" +
	"\x12GetPipelineRequest\x12!\n" +
	"\vpipeline_id\x18\x01 \x01(\tH\x00R\n" +
	"pipelineId\x12'\n" +
	"\x0epipeline_gpath\x18\x02 \x01(\tH\x00R\rpipelineGpathB\a\n" +
	"\x05query\"E\n" +
	...
	"\tpipelines\x18\x01 \x03(\v2\x14.gcc.PipelineSummaryR\tpipelines\"\xa5\x03\n" +
	...
	"\tform_code\x18\n" +
	" \x01(\tR\bformCodeJ\x04\b\x04\x10\x05\"o\n" +
...
var file_cc_proto_depIdxs = []int32{
	...
	3,  // 9: gcc.GetPipelineFinalEligibilityResponse.certs_quals:type_name -> gcc.Qualification
	3,  // 10: gcc.GetPipelineFinalEligibilityResponse.certs:type_name -> gcc.Qualification
	17, // 11: gcc.ListPipelinesResponse.pipelines:type_name -> gcc.PipelineSummary
	18, // 12: gcc.ListStagesResponse.stages:type_name -> gcc.StageSummary
	19, // 13: gcc.ListUnitsResponse.units:type_name -> gcc.UnitSummary
	31, // 14: gcc.CreateUploadURLResponse.signed_headers:type_name -> gcc.CreateUploadURLResponse.SignedHeadersEntry
	4,  // 15: gcc.CCService.CreatePipelineDraft:input_type -> gcc.CreatePipelineDraftRequest
	5,  // 16: gcc.CCService.DuplicatePipelineDraft:input_type -> gcc.DuplicatePipelineDraftRequest
	6,  // 17: gcc.CCService.UpdatePipelineStructure:input_type -> gcc.UpdatePipelineStructureRequest
	7,  // 18: gcc.CCService.PublishPipeline:input_type -> gcc.PublishPipelineRequest
	8,  // 19: gcc.CCService.DeprecatePipeline:input_type -> gcc.DeprecatePipelineRequest
	9,  // 20: gcc.CCService.DeletePipeline:input_type -> gcc.DeletePipelineRequest
	10, // 21: gcc.CCService.UpdatePipelineMetadata:input_type -> gcc.UpdateMetadataRequest
	...
	0,  // 34: gcc.CCService.DuplicatePipelineDraft:output_type -> gcc.PipelineConfig
	0,  // 35: gcc.CCService.UpdatePipelineStructure:output_type -> gcc.PipelineConfig
	0,  // 36: gcc.CCService.PublishPipeline:output_type -> gcc.PipelineConfig
	32, // 37: gcc.CCService.DeprecatePipeline:output_type -> google.protobuf.Empty
	32, // 38: gcc.CCService.DeletePipeline:output_type -> google.protobuf.Empty
	32, // 39: gcc.CCService.UpdatePipelineMetadata:output_type -> google.protobuf.Empty
	0,  // 40: gcc.CCService.GetPipeline:output_type -> gcc.PipelineConfig
	0,  // 41: gcc.CCService.GetPipelineDetail:output_type -> gcc.PipelineConfig
	13, // 42: gcc.CCService.GetPipelineFinalEligibility:output_type -> gcc.GetPipelineFinalEligibilityResponse
	16, // 43: gcc.CCService.ListPipelines:output_type -> gcc.ListPipelinesResponse
	16, // 44: gcc.CCService.ListPipelinesAdmin:output_type -> gcc.ListPipelinesResponse
	23, // 45: gcc.CCService.ListStages:output_type -> gcc.ListStagesResponse
	1,  // 46: gcc.CCService.GetStageDetail:output_type -> gcc.StageConfig
	26, // 47: gcc.CCService.ListUnits:output_type -> gcc.ListUnitsResponse
	2,  // 48: gcc.CCService.GetUnitDetail:output_type -> gcc.UnitConfig
	28, // 49: gcc.CCService.CreateUploadURL:output_type -> gcc.CreateUploadURLResponse
	30, // 50: gcc.CCService.GetPublicURL:output_type -> gcc.GetPublicURLResponse
...
func file_cc_proto_init() {
	...
	file_cc_proto_msgTypes[11].OneofWrappers = []any{
		...
		(*GetPipelineRequest_PipelineGpath)(nil),
	}
	...
	file_cc_proto_msgTypes[20].OneofWrappers = []any{
		...
		(*GetPipelineDetailRequest_PipelineGpath)(nil),
	}
