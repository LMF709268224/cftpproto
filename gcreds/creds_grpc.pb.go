...
const (
	...
	CredentialService_AdminPurgeCandidateCredentials_FullMethodName   = "/gcreds.CredentialService/AdminPurgeCandidateCredentials"
)
...
type CredentialServiceClient interface {
	...
	AdminPurgeCandidateCredentials(ctx context.Context, in *AdminPurgeCandidateCredentialsRequest, opts ...grpc.CallOption) (*AdminPurgeCandidateCredentialsResponse, error)
}
...
func (c *credentialServiceClient) AdminPurgeCandidateCredentials(ctx context.Context, in *AdminPurgeCandidateCredentialsRequest, opts ...grpc.CallOption) (*AdminPurgeCandidateCredentialsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(AdminPurgeCandidateCredentialsResponse)
	err := c.cc.Invoke(ctx, CredentialService_AdminPurgeCandidateCredentials_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CredentialServiceServer interface {
	...
	AdminPurgeCandidateCredentials(context.Context, *AdminPurgeCandidateCredentialsRequest) (*AdminPurgeCandidateCredentialsResponse, error)
...
func (UnimplementedCredentialServiceServer) AdminPurgeCandidateCredentials(context.Context, *AdminPurgeCandidateCredentialsRequest) (*AdminPurgeCandidateCredentialsResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method AdminPurgeCandidateCredentials not implemented")
}
...
func _CredentialService_AdminPurgeCandidateCredentials_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(AdminPurgeCandidateCredentialsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CredentialServiceServer).AdminPurgeCandidateCredentials(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: CredentialService_AdminPurgeCandidateCredentials_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CredentialServiceServer).AdminPurgeCandidateCredentials(ctx, req.(*AdminPurgeCandidateCredentialsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var CredentialService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "AdminPurgeCandidateCredentials",
			Handler:    _CredentialService_AdminPurgeCandidateCredentials_Handler,
		},
	},
