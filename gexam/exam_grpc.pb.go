...
const (
	...
	GExamService_AdminPurgeCandidateExams_FullMethodName  = "/gexam.GExamService/AdminPurgeCandidateExams"
)
...
type GExamServiceClient interface {
	...
	// 管理端：清理指定考生数据
	AdminPurgeCandidateExams(ctx context.Context, in *AdminPurgeCandidateExamsRequest, opts ...grpc.CallOption) (*AdminPurgeCandidateExamsResponse, error)
}
...
func (c *gExamServiceClient) AdminPurgeCandidateExams(ctx context.Context, in *AdminPurgeCandidateExamsRequest, opts ...grpc.CallOption) (*AdminPurgeCandidateExamsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(AdminPurgeCandidateExamsResponse)
	err := c.cc.Invoke(ctx, GExamService_AdminPurgeCandidateExams_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type GExamServiceServer interface {
	...
	// 管理端：清理指定考生数据
	AdminPurgeCandidateExams(context.Context, *AdminPurgeCandidateExamsRequest) (*AdminPurgeCandidateExamsResponse, error)
...
func (UnimplementedGExamServiceServer) AdminPurgeCandidateExams(context.Context, *AdminPurgeCandidateExamsRequest) (*AdminPurgeCandidateExamsResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method AdminPurgeCandidateExams not implemented")
}
...
func _GExamService_AdminPurgeCandidateExams_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(AdminPurgeCandidateExamsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(GExamServiceServer).AdminPurgeCandidateExams(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: GExamService_AdminPurgeCandidateExams_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GExamServiceServer).AdminPurgeCandidateExams(ctx, req.(*AdminPurgeCandidateExamsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var GExamService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "AdminPurgeCandidateExams",
			Handler:    _GExamService_AdminPurgeCandidateExams_Handler,
		},
	},
