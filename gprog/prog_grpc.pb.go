...
const (
	...
	ProgService_AdminPurgeCandidatePipeline_FullMethodName   = "/gprog.ProgService/AdminPurgeCandidatePipeline"
)
...
type ProgServiceClient interface {
	...
	AdminPurgeCandidatePipeline(ctx context.Context, in *AdminPurgeCandidatePipelineRequest, opts ...grpc.CallOption) (*AdminPurgeCandidatePipelineResponse, error)
}
...
func (c *progServiceClient) AdminPurgeCandidatePipeline(ctx context.Context, in *AdminPurgeCandidatePipelineRequest, opts ...grpc.CallOption) (*AdminPurgeCandidatePipelineResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(AdminPurgeCandidatePipelineResponse)
	err := c.cc.Invoke(ctx, ProgService_AdminPurgeCandidatePipeline_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ProgServiceServer interface {
	...
	AdminPurgeCandidatePipeline(context.Context, *AdminPurgeCandidatePipelineRequest) (*AdminPurgeCandidatePipelineResponse, error)
...
func (UnimplementedProgServiceServer) AdminPurgeCandidatePipeline(context.Context, *AdminPurgeCandidatePipelineRequest) (*AdminPurgeCandidatePipelineResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method AdminPurgeCandidatePipeline not implemented")
}
...
func _ProgService_AdminPurgeCandidatePipeline_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(AdminPurgeCandidatePipelineRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ProgServiceServer).AdminPurgeCandidatePipeline(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ProgService_AdminPurgeCandidatePipeline_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ProgServiceServer).AdminPurgeCandidatePipeline(ctx, req.(*AdminPurgeCandidatePipelineRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var ProgService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "AdminPurgeCandidatePipeline",
			Handler:    _ProgService_AdminPurgeCandidatePipeline_Handler,
		},
	},
