...
type AdminPurgeCandidateCredentialsRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	...
	CredDefId     string                 `protobuf:"bytes,2,opt,name=cred_def_id,json=credDefId,proto3" json:"cred_def_id,omitempty"`     // credential definition ID [required]
	AdminId       string                 `protobuf:"bytes,3,opt,name=admin_id,json=adminId,proto3" json:"admin_id,omitempty"`             // admin ID [required]
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *AdminPurgeCandidateCredentialsRequest) Reset() {
	*x = AdminPurgeCandidateCredentialsRequest{}
	mi := &file_creds_proto_msgTypes[56]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *AdminPurgeCandidateCredentialsRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AdminPurgeCandidateCredentialsRequest) ProtoMessage() {}

func (x *AdminPurgeCandidateCredentialsRequest) ProtoReflect() protoreflect.Message {
	mi := &file_creds_proto_msgTypes[56]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use AdminPurgeCandidateCredentialsRequest.ProtoReflect.Descriptor instead.
func (*AdminPurgeCandidateCredentialsRequest) Descriptor() ([]byte, []int) {
	return file_creds_proto_rawDescGZIP(), []int{56}
}

func (x *AdminPurgeCandidateCredentialsRequest) GetCandidateId() string {
	if x != nil {
		return x.CandidateId
	}
	return ""
...
func (x *AdminPurgeCandidateCredentialsRequest) GetCredDefId() string {
	if x != nil {
		return x.CredDefId
	}
	return ""
...
func (x *AdminPurgeCandidateCredentialsRequest) GetAdminId() string {
	if x != nil {
		return x.AdminId
	}
	return ""
...
type AdminPurgeCandidateCredentialsResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
...
func (x *AdminPurgeCandidateCredentialsResponse) Reset() {
	*x = AdminPurgeCandidateCredentialsResponse{}
	mi := &file_creds_proto_msgTypes[57]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *AdminPurgeCandidateCredentialsResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AdminPurgeCandidateCredentialsResponse) ProtoMessage() {}

func (x *AdminPurgeCandidateCredentialsResponse) ProtoReflect() protoreflect.Message {
	mi := &file_creds_proto_msgTypes[57]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use AdminPurgeCandidateCredentialsResponse.ProtoReflect.Descriptor instead.
func (*AdminPurgeCandidateCredentialsResponse) Descriptor() ([]byte, []int) {
	return file_creds_proto_rawDescGZIP(), []int{57}
}

func (x *AdminPurgeCandidateCredentialsResponse) GetSuccess() bool {
	if x != nil {
		return x.Success
	}
	return false
...
func (x *AdminPurgeCandidateCredentialsResponse) GetMessage() string {
	if x != nil {
		return x.Message
	}
	return ""
...
const file_creds_proto_rawDesc = "" +
	...
	"\fcandidate_id\x18\x01 \x01(\tR\vcandidateId\"\x8c\x02\n" +
	"\x1cEligibleCredentialDefinition\x12\x1e\n" +
	"\vcred_def_id\x18\x01 \x01(\tR\tcredDefId\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12\x1a\n" +
	"\bcategory\x18\x03 \x01(\tR\bcategory\x12 \n" +
	"\vdescription\x18\x04 \x01(\tR\vdescriptionJ\x04\b\x05\x10\x06J\x04\b\x06\x10\aJ\x04\b\a\x10\bJ\x04\b\b\x10\tR\x19latest_application_statusR\x15latest_application_idR\x19current_credential_statusR\x15current_credential_id\"r\n" +
	"(ListCandidateEligibleDefinitionsResponse\x12F\n" +
	"\vdefinitions\x18\x01 \x03(\v2$.gcreds.EligibleCredentialDefinitionR\vdefinitions\"\x85\x01\n" +
	"%AdminPurgeCandidateCredentialsRequest\x12!\n" +
	"\fcandidate_id\x18\x01 \x01(\tR\vcandidateId\x12\x1e\n" +
	"\vcred_def_id\x18\x02 \x01(\tR\tcredDefId\x12\x19\n" +
	"\badmin_id\x18\x03 \x01(\tR\aadminId\"\\\n" +
	"&AdminPurgeCandidateCredentialsResponse\x12\x18\n" +
	...
	"\x19PDF_REQUEST_STATUS_FAILED\x10\x042\x90\x19\n" +
	...
	"\x13CheckResourcesExist\x12\".gcreds.CheckResourcesExistRequest\x1a#.gcreds.CheckResourcesExistResponse\x12\x7f\n" +
	"\x1eAdminPurgeCandidateCredentials\x12-.gcreds.AdminPurgeCandidateCredentialsRequest\x1a..gcreds.AdminPurgeCandidateCredentialsResponseB\rZ\vcftp/gcredsb\x06proto3"
...
var file_creds_proto_msgTypes = make([]protoimpl.MessageInfo, 59)
var file_creds_proto_goTypes = []any{
	...
	(*AdminPurgeCandidateCredentialsRequest)(nil),    // 59: gcreds.AdminPurgeCandidateCredentialsRequest
	(*AdminPurgeCandidateCredentialsResponse)(nil),   // 60: gcreds.AdminPurgeCandidateCredentialsResponse
	nil, // 61: gcreds.RequestUploadUrlResponse.SignedHeadersEntry
}
var file_creds_proto_depIdxs = []int32{
	...
	61, // 16: gcreds.RequestUploadUrlResponse.signed_headers:type_name -> gcreds.RequestUploadUrlResponse.SignedHeadersEntry
	...
	57, // 21: gcreds.ListCandidateEligibleDefinitionsResponse.definitions:type_name -> gcreds.EligibleCredentialDefinition
	8,  // 22: gcreds.CredentialService.CreateCredentialDefinition:input_type -> gcreds.CreateCredentialDefinitionRequest
	47, // 23: gcreds.CredentialService.GetCredentialDefinitionDetail:input_type -> gcreds.GetCredentialDefinitionDetailRequest
	9,  // 24: gcreds.CredentialService.ListCredentialDefinitions:input_type -> gcreds.ListCredentialDefinitionsRequest
	11, // 25: gcreds.CredentialService.SubmitApplication:input_type -> gcreds.SubmitApplicationRequest
	13, // 26: gcreds.CredentialService.UpdateApplication:input_type -> gcreds.UpdateApplicationRequest
	12, // 27: gcreds.CredentialService.AuditApplication:input_type -> gcreds.AuditApplicationRequest
	48, // 28: gcreds.CredentialService.GetApplicationDetail:input_type -> gcreds.GetApplicationDetailRequest
	14, // 29: gcreds.CredentialService.ListCandidateApplications:input_type -> gcreds.ListApplicationsRequest
	54, // 30: gcreds.CredentialService.ListCandidateCredentials:input_type -> gcreds.ListCandidateCredentialsRequest
	56, // 31: gcreds.CredentialService.ListCandidateEligibleDefinitions:input_type -> gcreds.ListCandidateEligibleDefinitionsRequest
	14, // 32: gcreds.CredentialService.ListApplications:input_type -> gcreds.ListApplicationsRequest
	16, // 33: gcreds.CredentialService.GrantUploadPermission:input_type -> gcreds.GrantUploadPermissionRequest
	17, // 34: gcreds.CredentialService.RevokeUploadPermission:input_type -> gcreds.RevokeUploadPermissionRequest
	18, // 35: gcreds.CredentialService.CheckUploadPermission:input_type -> gcreds.CheckUploadPermissionRequest
	40, // 36: gcreds.CredentialService.RequestUploadUrl:input_type -> gcreds.RequestUploadUrlRequest
	50, // 37: gcreds.CredentialService.ListCredentials:input_type -> gcreds.ListCredentialsRequest
	49, // 38: gcreds.CredentialService.GetCredentialDetail:input_type -> gcreds.GetCredentialDetailRequest
	20, // 39: gcreds.CredentialService.GetLatestCredential:input_type -> gcreds.GetLatestCredentialRequest
	21, // 40: gcreds.CredentialService.CheckCandidateQualification:input_type -> gcreds.CheckCandidateQualificationRequest
	23, // 41: gcreds.CredentialService.GetCredentialVersion:input_type -> gcreds.GetCredentialVersionRequest
	24, // 42: gcreds.CredentialService.MarkExpired:input_type -> gcreds.MarkExpiredRequest
	25, // 43: gcreds.CredentialService.RevokeCredential:input_type -> gcreds.RevokeCredentialRequest
	27, // 44: gcreds.CredentialService.CreatePdfTemplate:input_type -> gcreds.CreatePdfTemplateRequest
	28, // 45: gcreds.CredentialService.UpdatePdfTemplate:input_type -> gcreds.UpdatePdfTemplateRequest
	29, // 46: gcreds.CredentialService.GetPdfTemplate:input_type -> gcreds.GetPdfTemplateRequest
	29, // 47: gcreds.CredentialService.GetPdfTemplateDetail:input_type -> gcreds.GetPdfTemplateRequest
	30, // 48: gcreds.CredentialService.ListPdfTemplates:input_type -> gcreds.ListPdfTemplatesRequest
	33, // 49: gcreds.CredentialService.CreatePdfRequest:input_type -> gcreds.CreatePdfRequestRequest
	34, // 50: gcreds.CredentialService.UpdatePdfRequest:input_type -> gcreds.UpdatePdfRequestRequest
	35, // 51: gcreds.CredentialService.GetPdfRequest:input_type -> gcreds.GetPdfRequestRequest
	35, // 52: gcreds.CredentialService.GetPdfRequestDetail:input_type -> gcreds.GetPdfRequestRequest
	36, // 53: gcreds.CredentialService.GetPdfCertificate:input_type -> gcreds.GetPdfCertificateRequest
	38, // 54: gcreds.CredentialService.ListPdfRequests:input_type -> gcreds.ListPdfRequestsRequest
	52, // 55: gcreds.CredentialService.CheckResourcesExist:input_type -> gcreds.CheckResourcesExistRequest
	59, // 56: gcreds.CredentialService.AdminPurgeCandidateCredentials:input_type -> gcreds.AdminPurgeCandidateCredentialsRequest
	...
	60, // 91: gcreds.CredentialService.AdminPurgeCandidateCredentials:output_type -> gcreds.AdminPurgeCandidateCredentialsResponse
